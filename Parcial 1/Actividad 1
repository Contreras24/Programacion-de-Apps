  ...
  return(
    ...
    <View>
      <Image
          style={page.tinyLogo}
          source={{
            uri: 'https://media.tycsports.com/files/2021/09/11/330592/cristiano-ronaldo-el-bicho-en-manchester-united_1440x810_wmk.jpg?v=1',
          }}
        />
      <Text style={flattenStyle}>El bichoo Siuuuuuu</Text>
      <Text>Estilo:</Text>
